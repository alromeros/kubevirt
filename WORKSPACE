...
rpm(
    name = "glibc-langpack-eo-0__2.39-141.el10.x86_64",
    sha256 = "4c393a2e9f61529be6a4e4fa0cc0c114389cb99dfd8ba8123d7ea2078609ed1c",
    urls = [
        "http://mirror.stream.centos.org/10-stream/BaseOS/x86_64/os/Packages/glibc-langpack-eo-2.39-141.el10.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-langpack-ff-0__2.39-141.el10.aarch64",
    sha256 = "e4a7d455284fa9372503ecd0e6e685d8f289af3390c30bb069100f0e4a14b517",
    urls = [
        "http://mirror.stream.centos.org/10-stream/BaseOS/aarch64/os/Packages/glibc-langpack-ff-2.39-141.el10.aarch64.rpm",
    ],
)
...
rpm(
    name = "glibc-langpack-gez-0__2.34-277.el9.s390x",
    sha256 = "93ca6a2bbe6601b35321a714cec46fad38f43a9c2c711b04bdd832d179e7ae98",
    urls = [
        "http://mirror.stream.centos.org/9-stream/BaseOS/s390x/os/Packages/glibc-langpack-gez-2.34-277.el9.s390x.rpm",
    ],
)
